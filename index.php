            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-12 text-center mx-auto">
                        <h2 class="mb-5">Welcome to ICE Community</h2>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="https://edu.sltc.ac.lk/study/ENTECH-scholarships" class="d-block">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="custom-text-box">
                            ...
                            <p class="mb-0  text-justify">We are a growing community formed by the students of SLTC Research University following the degree program of BSc. (Hons) Engineering in Information and Communication Engineering. Our idea of a community is one where all members get to develop their skills at their own pace by contributing to our projects under the guidance of more experienced members. We are determined to expand as a reputed organization locally as well as globally.</p>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="custom-text-box mb-lg-0">
                                    ...
                                    <small>To create high quality IT solutions within a strong community of highly motivated, knowledgeable and efficient individuals who can undertake responsibilities and contribute to any kind of workplace.</small>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="custom-text-box d-flex flex-wrap d-lg-block mb-lg-0">
                                    ...
                                    <div class="counter-thumb mt-4">
                                        <div class="d-flex">
                                            <span class="counter-number" data-from="1" data-to="89"
                                                data-speed="1000"></span>
                                            <span class="counter-number-text"></span>
                                        </div>

                                        <span class="counter-text">Undergraduates</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-5 col-12">
                        <img src="https://edu.sltc.ac.lk/uploads/staff/Yohan_Padigama.jpg"
                            class="about-image ms-lg-auto bg-light shadow-lg img-fluid" alt="">
                    </div>

                    <div class="col-lg-6 col-md-7 col-12">
                        <div class="custom-text-block">
                            <h2 class="mb-0">Mr. Yohan Pandigama</h2>

                            <p class="text-muted mb-lg-4 mb-md-4">Academic Advisor</p>

                            <p>Coming from a general information technology background, now I would like to be recognized as a computer science enthusiast. For me, computer science is not merely another area of studies and research, but is more a way of life. Four areas that inspired and motivating me in computer science are natural algorithms, theory of computation, the philosophy of computer science and the learning theory. My main focus currently revolves around in the area of machine learning and data analytics.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        ...
                        <img src="images/smiling-casual-woman-dressed-volunteer-t-shirt-with-badge.jpg"
                            class="volunteer-image img-fluid" alt=""></div>
                    ...
                    <div class="col-lg-7 col-12">
                        <div class="news-block">
                            ...
                            <div class="news-block-info">
                                ...
                                <div class="news-block-title mb-2">
                                    <h4><a href="news-detail" class="news-block-title-link">Clothing donation to
                                            urban area</a></h4>
                                </div>
                        ...
                        <div class="news-block mt-3">
                            ...
                            <div class="news-block-info">
                                ...
                                <div class="news-block-title mb-2">
                                    <h4><a href="news-detail" class="news-block-title-link">Food donation area</a>
                                    </h4>
                                </div>
                    ...
                    <div class="col-lg-4 col-12 mx-auto">
                        ...
                        <div class="news-block news-block-two-col d-flex mt-4">
                            ...
                            <div class="news-block-two-col-info">
                                <div class="news-block-title mb-2">
                                    <h6><a href="news-detail" class="news-block-title-link">Food donation area</a>
                                    </h6>
                                </div>
                        ...
                        <div class="news-block news-block-two-col d-flex mt-4">
                            ...
                            <div class="news-block-two-col-info">
                                <div class="news-block-title mb-2">
                                    <h6><a href="news-detail" class="news-block-title-link">Volunteering Clean</a>
                                    </h6>
                                </div>
                    ...
                    <div class="col-lg-4 col-12 ms-auto mb-5 mb-lg-0">
                        <div class="contact-info-wrap">
                            ...
                            <div class="contact-image-wrap d-flex flex-wrap">
                                <img src="https://media-exp1.licdn.com/dms/image/D5603AQH8WqEk_asLjQ/profile-displayphoto-shrink_800_800/0/1667753468093?e=2147483647&v=beta&t=OLxc9hu78R8jYA6exTNsYTwRujX4MpCaDTvFsj7E-uY"
                                    class="img-fluid avatar-image" alt="">

                                <div class="d-flex flex-column justify-content-center ms-3">
                                    <p class="mb-0">Dumindu Udara</p>
                                    <p class="mb-0"><strong>Coordinator</strong></p>
                                </div>
                            </div>
                            ...
                            <div class="contact-info">
                                ...
                                <a href="https://g.page/SLTCampus?share" target="_blank" class="custom-btn btn mt-3">Get Direction</a>
                            </div>
                        </div>
                    </div>
